const blogs = [
    {
        title: 'Exploring the Legacy of BMW: The Ultimate Driving Machine',
        content: 'When it comes to the world of automobiles, one name that has consistently stood out for over a century is BMW - Bayerische Motoren Werke AG or Bavarian Motor Works. Founded in 1916, this German automotive giant has left an indelible mark on the industry with its commitment to engineering excellence, innovation, and a passion for creating the ultimate driving machines.\n\n' + 
        'BMW s journey began in the early 20th century when it focused on aircraft engine production. However, after World War I, the Treaty of Versailles led the company to shift its focus to motorcycles and automobiles. The first BMW car, the Dixi, rolled off the production line in 1928, marking the beginning of a legacy that would span generations.\n\n' +
    ...
    },
    {
        ...
        content: 'Few cars have left an indelible mark on the automotive world quite like the Ford Mustang. Since its inception in 1964, the Mustang has embodied the spirit of American muscle cars, offering power, style, and performance that have become legendary. Let s take a journey through the decades to explore the enduring legacy of this iconic automobile. \n\n' + 
        'The Ford Mustang was introduced on April 17, 1964, as a compact, affordable sports car with a sleek design and a focus on customization. It was an instant hit, with over a million units sold within the first two years. The Mustang s success established a new class of cars known as "pony cars" and ignited a rivalry with the Chevrolet Camaro that endures to this day. \n\n' +
        'The 1960s and 70s saw the Mustang undergo several transformations. It grew in size and power, evolving into a true muscle car. Iconic models like the Mustang GT and Mach 1 became synonymous with high-performance driving and exhilarating V8 engines that roared with authority.\n\n' +
        'The Mustangs popularity wasnt confined to the racetrack; it also made a name for itself in Hollywood. The car achieved legendary status through films like "Bullitt" and "Gone in 60 Seconds," where it showcased its speed and charisma on the silver screen.\n\n' +
        'The 1970s brought a shift in focus as automakers adapted to stricter emission standards and rising fuel prices. The Mustang downsized and embraced more fuel-efficient engines, but it never lost its spirit. Enthusiasts fondly remember the Mustang II and its Cobra II variant.\n\n' +
